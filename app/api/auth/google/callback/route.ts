import { GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, authOrigin, failLogin, finishSocial, readOAuthState, tokenFailReason } from "@/lib/oauth";
...
export async function GET(req: Request) {
  ...
  return finishSocial(req, "google", me.id ? String(me.id) : "");
}
